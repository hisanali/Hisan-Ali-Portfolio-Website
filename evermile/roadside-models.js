...
export class RoadsideModels {
 constructor(world){this.loaded={};this.errors=[];const loader=new GLTFLoader();for(const key of ['pump','shop','canopy','signal','ice','bin'])loader.load(new URL('./assets/models/prop-'+key+'.glb?v=supplied7',import.meta.url).href,g=>{
