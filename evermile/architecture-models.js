...
export class ArchitectureModels{
 constructor(world){this.loaded={};this.errors=[];const loader=new GLTFLoader();for(const key of ['apartments','brick-works','coastal-fort'])loader.load(new URL('./assets/models/place-'+key+'.glb?v=transit3',import.meta.url).href,g=>{
