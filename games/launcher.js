(() => {
  ...
  const bundles3D = { snake: '/games/snake3d.bundle.js?v=1', stack: '/games/arcade3d.bundle.js?v=3', flight: '/games/arcade3d.bundle.js?v=3', pong: '/games/arcade3d.bundle.js?v=3', gravity: '/games/arcade3d.bundle.js?v=3' };
  const load3D = (game) => {
